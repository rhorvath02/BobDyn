...
model TestTabularDamper
  ...
  Modelica.Mechanics.MultiBody.Parts.Body body(m = 70, r_CM = {0, 0, 0}, animation = false) annotation(
    Placement(transformation(origin = {30, 0}, extent = {{-10, -10}, {10, 10}})));
  // Damper under test
  BobLib.Vehicle.Chassis.Suspension.Linkages.TabularDamper tabularDamper(force_table = [-0.1, 1000; 0.0, 0; 0.2, -1000; 0.4, -10000], start_point = {-0.01102743, 0.34553503, 0.41125991}, end_point = {-0.02067347, 0.24784709, 0.56145693}) annotation(
