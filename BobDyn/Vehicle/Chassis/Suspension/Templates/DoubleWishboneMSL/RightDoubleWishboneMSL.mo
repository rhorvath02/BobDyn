...
equation
  ...
  connect(sphericalSpherical.frame_a, lower_to_tie.frame_b) annotation(
    Line(points = {{50, 0}, {50, -20}, {20, -20}, {20, 20}}, color = {95, 95, 95}));
end RightDoubleWishboneMSL;
