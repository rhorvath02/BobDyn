...
equation
  ...
  Icon(graphics = {Ellipse(fillPattern = FillPattern.Solid, lineThickness = 2, extent = {{-15, -15}, {15, 15}}), Line(origin = {0, -81}, points = {{0, -19}, {0, 19}}, thickness = 5), Text( origin = {-2, 6},textColor = {255, 0, 0}, extent = {{-100, 100}, {100, -100}}, textString = "1DOF")}),
  Diagram(graphics));
end Wheel1DOF_Y;
