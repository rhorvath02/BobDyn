...
model RigidChassis
  ...
  BobLib.Vehicle.Chassis.Suspension.FrAxleDWPushBCARB FrAxle(FrAxle = Fr_axle_props,
                                                             ...
                                                             redeclare final BobLib.Vehicle.Chassis.Suspension.Templates.Tire.BaseTire left_tire(rim_width = Fr_tire_props.RIM_WIDTH,
                                                             ...
                                                             redeclare final BobLib.Vehicle.Chassis.Suspension.Templates.Tire.BaseTire right_tire(rim_width = Fr_tire_props.RIM_WIDTH,
                                                                                                                              rim_R0 = Fr_tire_props.RIM_RADIUS,
                                                                                                                              R0 = Fr_tire_props.UNLOADED_RADIUS,
                                                                                                                              tire_c = Fr_tire_props.VERTICAL_STIFFNESS,
  ...
  BobLib.Vehicle.Chassis.Suspension.RrAxleDWPullBCARB RrAxle(RrAxle = Rr_axle_props,
                                                             ...
                                                             final link_diameter = 0.025,
                                                             final joint_diameter = 0.030/*,
                                                             redeclare final BobLib.Vehicle.Chassis.Suspension.Templates.Tire.BaseTire left_tire(rim_width = Rr_tire_props.RIM_WIDTH,
                                                             ...
                                                             redeclare final BobLib.Vehicle.Chassis.Suspension.Templates.Tire.BaseTire right_tire(rim_width = Rr_tire_props.RIM_WIDTH,
                                                                                                                              rim_R0 = Rr_tire_props.RIM_RADIUS,
                                                                                                                              R0 = Rr_tire_props.UNLOADED_RADIUS,
                                                                                                                              tire_c = Rr_tire_props.VERTICAL_STIFFNESS,
                                                                                                                              tire_d = Rr_tire_props.VERTICAL_DAMPING)*/
