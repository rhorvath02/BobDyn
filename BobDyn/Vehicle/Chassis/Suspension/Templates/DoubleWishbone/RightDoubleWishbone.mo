within BobDyn.Vehicle.Chassis.Suspension.Templates.DoubleWishbone;

model RightDoubleWishbone
  extends BobDyn.Vehicle.Chassis.Suspension.Templates.DoubleWishbone.DoubleWishboneBase;
