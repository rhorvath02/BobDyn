...
model TestBellcrank3pu1p
  ...
  BobLib.Vehicle.Chassis.Suspension.Linkages.Bellcrank3pu1p bellcrank(pivot = {0, 0, 0}, pivot_ref = {1, 0, 0}, pickup_1 = {0, 0.25, 0}, pickup_2 = {0, 0.5, 0.25}, pickup_3 = {0, 0.25, 0.15})  annotation(
