...
model RrAxleDWPullBCARB
  ...
  extends BobLib.Vehicle.Chassis.Suspension.Templates.AxleDoubleWishboneBase(Axle = RrAxle,
                                                                              left_unsprung_mass = unsprung_mass,
                                                                              left_uca_mass = uca_mass,
                                                                              left_lca_mass = lca_mass,
                                                                              left_tie_mass = tie_mass,
                                                                              final left_tire(rim_width = Rr_tire.RIM_WIDTH,
                                                                                              rim_R0 = Rr_tire.RIM_RADIUS,
                                                                                              wheel_J = Rr_tire.INERTIA,
                                                                              ...
                                                                              final right_tire(rim_width = Rr_tire.RIM_WIDTH,
                                                                                               rim_R0 = Rr_tire.RIM_RADIUS,
                                                                                               wheel_J = Rr_tire.INERTIA,
                                                                                               R0 = Rr_tire.UNLOADED_RADIUS,
                                                                                               tire_c = Rr_tire.VERTICAL_STIFFNESS,
  ...
  BobLib.Vehicle.Chassis.Suspension.Linkages.TabularSpring left_tabular_spring(spring_table = RrAxle.spring_table,
                                                                               free_length = RrAxle.free_length,
                                                                               spring_diameter = 0.050) annotation(
    Placement(transformation(origin = {50, 70}, extent = {{-10, -10}, {10, 10}})));
  
  BobLib.Vehicle.Chassis.Suspension.Linkages.TabularDamper left_tabular_damper(damper_table = [0, 0; 1, 1e3],
  ...
  final Modelica.Mechanics.MultiBody.Parts.FixedTranslation right_shock_pickup(r = {left_shock_mount[1], -left_shock_mount[2], left_shock_mount[3]} - effective_center) annotation(
    Placement(transformation(origin = {20, 70}, extent = {{-10, -10}, {10, 10}})));
  BobLib.Vehicle.Chassis.Suspension.Linkages.TabularSpring right_tabular_spring(spring_table = RrAxle.spring_table,
                                                                                        free_length = RrAxle.free_length,
                                                                                        spring_diameter = 0.050) annotation(
    Placement(transformation(origin = {-50, 70}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
  BobLib.Vehicle.Chassis.Suspension.Linkages.TabularDamper right_tabular_damper(damper_table = RrAxle.damper_table,
                                                                                        inner_diameter = 0.004,
                                                                                        outer_diameter = 0.008) annotation(
...
//  final BobLib.Vehicle.Chassis.Suspension.Linkages.Stabar stabar(left_arm_end = RrAxleBC.left_arm_end,
...
equation
  ...
  connect(left_shock_pickup.frame_a, axle_frame) annotation(
    Line(points = {{-10, 70}, {0, 70}, {0, -100}}, color = {95, 95, 95}));
  connect(left_shock_pickup.frame_b, right_tabular_spring.frame_a) annotation(
    Line(points = {{-30, 70}, {-40, 70}}, color = {95, 95, 95}));
  connect(left_bellcrank_mount.frame_b, left_bellcrank.mount_frame) annotation(
