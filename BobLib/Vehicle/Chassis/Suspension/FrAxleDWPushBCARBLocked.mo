...
model FrAxleDWPushBCARBLocked
  ...
  extends BobLib.Vehicle.Chassis.Suspension.Templates.AxleDoubleWishboneBase(Axle = FrAxle,
                                                                             ...
                                                                             redeclare final BobLib.Vehicle.Chassis.Tires.BaseTire left_tire(rim_width = Fr_tire.RIM_WIDTH,
                                                                                                                                             rim_R0 = Fr_tire.RIM_RADIUS,
                                                                                                                                             R0 = Fr_tire.UNLOADED_RADIUS,
                                                                                                                                             tire_c = Fr_tire.VERTICAL_STIFFNESS,
                                                                                                                                             tire_d = Fr_tire.VERTICAL_DAMPING),
                                                                             redeclare final BobLib.Vehicle.Chassis.Tires.BaseTire right_tire(rim_width = Fr_tire.RIM_WIDTH,
                                                                                                                                              rim_R0 = Fr_tire.RIM_RADIUS,
                                                                                                                                              R0 = Fr_tire.UNLOADED_RADIUS,
                                                                                                                                              tire_c = Fr_tire.VERTICAL_STIFFNESS,
                                                                                                                                              tire_d = Fr_tire.VERTICAL_DAMPING));
  ...
  final BobLib.Vehicle.Chassis.Suspension.Linkages.TabularSpring left_tabular_spring(spring_table = [0, 0; 1, 0],
                                                                                   free_length = FrAxle.free_length,
                                                                                   spring_diameter = 0.050) annotation(
    Placement(transformation(origin = {-50, 70}, extent = {{10, -10}, {-10, 10}})));
  final BobLib.Vehicle.Chassis.Suspension.Linkages.TabularDamper left_tabular_damper(damper_table = [0, 0; 1, 0],
...
// right bellcrank
  ...
  final Modelica.Mechanics.MultiBody.Parts.FixedTranslation right_shock_pickup(r = {left_shock_mount[1], -left_shock_mount[2], left_shock_mount[3]} - effective_center) annotation(
    Placement(transformation(origin = {20, 70}, extent = {{-10, -10}, {10, 10}})));
  final BobLib.Vehicle.Chassis.Suspension.Linkages.TabularSpring right_tabular_spring(spring_table = [0, 0; 1, 0],
                                                                                   free_length = FrAxle.free_length,
                                                                                   spring_diameter = 0.050)  annotation(
    Placement(transformation(origin = {50, 70}, extent = {{-10, -10}, {10, 10}})));
  final BobLib.Vehicle.Chassis.Suspension.Linkages.TabularDamper right_tabular_damper(damper_table = [0, 0; 1, 0],
                                                                                        inner_diameter = 0.004,
                                                                                        outer_diameter = 0.008) annotation(
