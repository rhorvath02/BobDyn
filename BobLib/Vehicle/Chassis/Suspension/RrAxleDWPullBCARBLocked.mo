...
model RrAxleDWPullBCARBLocked
  ...
  extends BobLib.Vehicle.Chassis.Suspension.Templates.AxleDoubleWishboneBase(Axle = RrAxle,
                                                                             ...
                                                                             redeclare final BobLib.Vehicle.Chassis.Tires.BaseTire left_tire(rim_width = Rr_tire.RIM_WIDTH,
                                                                                                                                             rim_R0 = Rr_tire.RIM_RADIUS,
                                                                                                                                             R0 = Rr_tire.UNLOADED_RADIUS,
                                                                                                                                             tire_c = Rr_tire.VERTICAL_STIFFNESS,
                                                                                                                                             tire_d = Rr_tire.VERTICAL_DAMPING),
                                                                             redeclare final BobLib.Vehicle.Chassis.Tires.BaseTire right_tire(rim_width = Rr_tire.RIM_WIDTH,
                                                                                                                                              rim_R0 = Rr_tire.RIM_RADIUS,
                                                                                                                                              R0 = Rr_tire.UNLOADED_RADIUS,
                                                                                                                                              tire_c = Rr_tire.VERTICAL_STIFFNESS,
                                                                                                                                              tire_d = Rr_tire.VERTICAL_DAMPING));
