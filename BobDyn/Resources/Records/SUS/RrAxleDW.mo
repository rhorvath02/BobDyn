...
record RrAxleDW
  ...
  parameter SIunits.Position upper_fore_i[3] = {-1.279144, 0.2972308, 0.2782342};
  parameter SIunits.Position upper_aft_i[3] = {-1.4993874, 0.283845, 0.2184336};
  parameter SIunits.Position upper_outboard[3] = {-1.5540736, 0.5267706, 0.29464};
  parameter SIunits.Position lower_fore_i[3] = {-1.3142214, 0.283464, 0.111868};
  parameter SIunits.Position lower_aft_i[3] = {-1.4998192, 0.2835148, 0.0622236};
  ...
  parameter Real free_length = 0.27490478;
  parameter Real spring_table[2, 2] = [0, 0; 1, 43782];
  ...
  parameter SIunits.Position frame_height_sensor[3] = {-1.5494, 0.2683979, 0.06731};
