...
model OrionChassis
  ...
  final Modelica.Blocks.Sources.RealExpression torque_cmd_expr(y = torque_cmd)  annotation(
...
// Wheel sensing
  ...
  connect(torque_cmd_expr.y, Rr_torque.tau) annotation(
