...
// Inclination angle
  ...
  connect(hub_input, tire2DOF.hub_frame) annotation(
    Line(points = {{0, 100}, {0, 10}}));
  annotation(
    Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}), graphics = {Line(origin = {50, 0}, points = {{-10, 0}, {50, 0}}, pattern = LinePattern.Dash, thickness = 1), Line(origin = {-50, 0}, points = {{-50, 0}, {10, 0}}), Rectangle(fillColor = {71, 71, 71}, fillPattern = FillPattern.Solid, extent = {{-40, 80}, {40, -80}}, radius = 5), Line(origin = {0, -90}, points = {{0, -10}, {0, 10}}), Text( origin = {-1, 4},textColor = {255, 0, 0}, extent = {{-77, 96}, {77, -96}}, textString = "BASE")}),
    Diagram(graphics));
end BaseTireV2;
