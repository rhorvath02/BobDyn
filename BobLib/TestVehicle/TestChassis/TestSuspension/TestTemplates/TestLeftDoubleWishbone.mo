...
model TestLeftDoubleWishbone
  ...
  parameter BobLib.Resources.Records.SUS.RrAxleDW RrAxle annotation(Evaluate=true);
  final parameter BobLib.Resources.Records.SUS.RrAxleDWPullBCARB RrAxleBC;
  
  final parameter BobLib.Resources.Records.MASSPROPS.RrUnsprung unsprung_mass;
  final parameter BobLib.Resources.Records.MASSPROPS.RrUCA uca_mass;
  final parameter BobLib.Resources.Records.MASSPROPS.RrLCA lca_mass;
  final parameter BobLib.Resources.Records.MASSPROPS.RrTie tie_mass;
  
  final parameter BobLib.Resources.Records.TIRES.Fr_tire Fr_tire;
  ...
  BobLib.Vehicle.Chassis.Suspension.Templates.DoubleWishbone.LeftDoubleWishbone leftDoubleWishbone(Axle = RrAxle,
  ...
  BobLib.Utilities.Mechanics.Multibody.LinearActuator left_linear_actuator(axis = "z") annotation(
