...
model AxleDW
  ...
  // ============================================
  parameter BodyTemplate right_unsprung_mass = BodyTemplate(m = left_unsprung_mass.m, r_cm = {left_unsprung_mass.r_cm[1], -left_unsprung_mass.r_cm[2], left_unsprung_mass.r_cm[3]}, I = {{left_unsprung_mass.I[1, 1], -left_unsprung_mass.I[1, 2], left_unsprung_mass.I[1, 3]}, {-left_unsprung_mass.I[2, 1], left_unsprung_mass.I[2, 2], -left_unsprung_mass.I[2, 3]}, {left_unsprung_mass.I[3, 1], -left_unsprung_mass.I[3, 2], left_unsprung_mass.I[3, 3]}}) "Right unsprung mass" annotation(
    Evaluate = false,
    Dialog(tab = "Mass Properties", group = "Wheel Properties"));
  parameter BodyTemplate right_uca_mass = BodyTemplate(m = left_uca_mass.m, r_cm = {left_uca_mass.r_cm[1], -left_uca_mass.r_cm[2], left_uca_mass.r_cm[3]}, I = {{left_uca_mass.I[1, 1], -left_uca_mass.I[1, 2], left_uca_mass.I[1, 3]}, {-left_uca_mass.I[2, 1], left_uca_mass.I[2, 2], -left_uca_mass.I[2, 3]}, {left_uca_mass.I[3, 1], -left_uca_mass.I[3, 2], left_uca_mass.I[3, 3]}}) "Right upper control arm mass" annotation(
    Evaluate = false,
    Dialog(tab = "Mass Properties", group = "UCA Properties"));
  parameter BodyTemplate right_lca_mass = BodyTemplate(m = left_lca_mass.m, r_cm = {left_lca_mass.r_cm[1], -left_lca_mass.r_cm[2], left_lca_mass.r_cm[3]}, I = {{left_lca_mass.I[1, 1], -left_lca_mass.I[1, 2], left_lca_mass.I[1, 3]}, {-left_lca_mass.I[2, 1], left_lca_mass.I[2, 2], -left_lca_mass.I[2, 3]}, {left_lca_mass.I[3, 1], -left_lca_mass.I[3, 2], left_lca_mass.I[3, 3]}}) "Right lower control arm mass" annotation(
    Evaluate = false,
    Dialog(tab = "Mass Properties", group = "LCA Properties"));
  parameter BodyTemplate right_tie_mass = BodyTemplate(m = left_tie_mass.m, r_cm = {left_tie_mass.r_cm[1], -left_tie_mass.r_cm[2], left_tie_mass.r_cm[3]}, I = {{left_tie_mass.I[1, 1], -left_tie_mass.I[1, 2], left_tie_mass.I[1, 3]}, {-left_tie_mass.I[2, 1], left_tie_mass.I[2, 2], -left_tie_mass.I[2, 3]}, {left_tie_mass.I[3, 1], -left_tie_mass.I[3, 2], left_tie_mass.I[3, 3]}}) "Right tie rod mass" annotation(
    Evaluate = false,
    Dialog(tab = "Mass Properties", group = "Tie Properties"));
  // Visual parameters
  ...
  DoubleWishbone.TieClosure LeftTieClosure(inboard = Axle.tie_inboard, outboard = Axle.tie_outboard, link_diameter = link_diameter, joint_diameter = joint_diameter) annotation(
    Placement(transformation(origin = {-60, 100}, extent = {{20, -20}, {-20, 20}})));
  DoubleWishbone.WishboneUprightLoop RightWishboneUprightLoop(upper_fore_i = {Axle.upper_fore_i[1], -Axle.upper_fore_i[2], Axle.upper_fore_i[3]}, upper_aft_i = {Axle.upper_aft_i[1], -Axle.upper_aft_i[2], Axle.upper_aft_i[3]}, lower_fore_i = {Axle.lower_fore_i[1], -Axle.lower_fore_i[2], Axle.lower_fore_i[3]}, lower_aft_i = {Axle.lower_aft_i[1], -Axle.lower_aft_i[2], Axle.lower_aft_i[3]}, upper_o = {Axle.upper_outboard[1], -Axle.upper_outboard[2], Axle.upper_outboard[3]}, lower_o = {Axle.lower_outboard[1], -Axle.lower_outboard[2], Axle.lower_outboard[3]}, link_diameter = link_diameter, joint_diameter = joint_diameter) annotation(
    Placement(transformation(origin = {69, 50}, extent = {{-29, -29}, {29, 29}})));
  DoubleWishbone.TieClosure RightTieClosure(inboard = {Axle.tie_inboard[1], -Axle.tie_inboard[2], Axle.tie_inboard[3]}, outboard = {Axle.tie_outboard[1], -Axle.tie_outboard[2], Axle.tie_outboard[3]}, link_diameter = link_diameter, joint_diameter = joint_diameter) annotation(
    Placement(transformation(origin = {60, 100}, extent = {{-20, -20}, {20, 20}})));
  ...
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation right_tie_connection(r = {Axle.lower_outboard[1], -Axle.lower_outboard[2], Axle.lower_outboard[3]} - {Axle.tie_outboard[1], -Axle.tie_outboard[2], Axle.tie_outboard[3]}) annotation(
    Placement(transformation(origin = {100, 70}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  ...
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation to_right_wheel_center(r = {Axle.wheel_center[1], -Axle.wheel_center[2], Axle.wheel_center[3]} - {Axle.lower_outboard[1], -Axle.lower_outboard[2], Axle.lower_outboard[3]}) annotation(
    Placement(transformation(origin = {120, 30}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Mechanics.MultiBody.Parts.Body right_uca_body(r_CM = right_uca_mass.r_cm - {Axle.upper_outboard[1], -Axle.upper_outboard[2], Axle.upper_outboard[3]}, m = right_uca_mass.m, sphereDiameter = joint_diameter, cylinderDiameter = link_diameter, I_11 = right_uca_mass.I[1, 1], I_22 = right_uca_mass.I[2, 2], I_33 = right_uca_mass.I[3, 3], I_21 = right_uca_mass.I[2, 1], I_31 = right_uca_mass.I[3, 1], I_32 = right_uca_mass.I[3, 2]) annotation(
    Placement(transformation(origin = {130, 90}, extent = {{-10, -10}, {10, 10}}, rotation = -0)));
...
equation
  ...
  connect(RackAndPinion.left_frame, LeftTieClosure.tie_i_frame) annotation(
    Line(points = {{-20, 110}, {-30, 110}, {-30, 100}, {-40, 100}}, color = {95, 95, 95}));
  connect(RackAndPinion.right_frame, RightTieClosure.tie_i_frame) annotation(
    Line(points = {{20, 110}, {30, 110}, {30, 100}, {40, 100}}, color = {95, 95, 95}));
  connect(LeftTieClosure.tie_o_frame, left_tie_connection.frame_a) annotation(
    Line(points = {{-80, 100}, {-100, 100}, {-100, 80}}, color = {95, 95, 95}));
  connect(RightTieClosure.tie_o_frame, right_tie_connection.frame_a) annotation(
    Line(points = {{80, 100}, {100, 100}, {100, 80}}, color = {95, 95, 95}));
  ...
  connect(left_uca_body.frame_a, LeftWishboneUprightLoop.upper_o_frame) annotation(
    Line(points = {{-120, 90}, {-68, 90}, {-68, 78}}, color = {95, 95, 95}));
  ...
  connect(right_uca_body.frame_a, RightWishboneUprightLoop.upper_o_frame) annotation(
    Line(points = {{120, 90}, {70, 90}, {70, 78}}, color = {95, 95, 95}));
