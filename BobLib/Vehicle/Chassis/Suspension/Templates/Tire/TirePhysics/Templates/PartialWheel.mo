...
// Visualizers
  ...
  Modelica.Blocks.Sources.RealExpression Fx_reaction1(y = partialWheelParams.R0) annotation(
    Placement(transformation(origin = {-70, 70}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedTranslation(r = {0, 0, -1}*partialWheelParams.R0)  annotation(
...
equation
  ...
  connect(Fx_reaction1.y, tire_torque.u1) annotation(
    Line(points = {{-58, 70}, {-50, 70}, {-50, 66}, {-32, 66}}, color = {0, 0, 127}));
  connect(hub_axis.frame_a, fixedTranslation.frame_a) annotation(
    Line(points = {{10, 0}, {0, 0}, {0, -40}}, color = {95, 95, 95}));
  connect(fixedTranslation.frame_b, cp_frame) annotation(
